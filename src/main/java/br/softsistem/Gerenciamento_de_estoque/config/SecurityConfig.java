    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/sugestoes/**").hasRole("SUPER_ADMIN")
                        ...
                        .requestMatchers("/admin/pesquisa-preco/**").hasRole("SUPER_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/pesquisa-preco").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/pesquisa-preco/**").authenticated()
                        .requestMatchers("/api/org/login-logs/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/sugestoes").hasAnyRole("ADMIN", "SUPER_ADMIN")
