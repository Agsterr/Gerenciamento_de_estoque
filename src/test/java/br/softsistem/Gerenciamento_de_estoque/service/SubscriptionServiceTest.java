...
//
//    @Test
//    void testUpdateSubscriptionStatusByUserId() {
//        // Arrange: usuário tem assinatura atual (TRIAL ou ACTIVE)
//        when(subscriptionRepository.findByUserIdAndStatusIn(eq(1L), anyList()))
//            .thenReturn(Optional.of(testSubscription));
//        when(subscriptionRepository.save(any(Subscription.class)))
//            .thenReturn(testSubscription);
//
//        // Act
//        subscriptionService.updateSubscriptionStatusByUserId(1L, SubscriptionStatus.ACTIVE);
//
//        // Assert
//        verify(subscriptionRepository).save(any(Subscription.class));
