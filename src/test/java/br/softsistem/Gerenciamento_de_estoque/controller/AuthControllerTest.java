...
//
//        assertThrows(RuntimeException.class, () -> authController.login(requisicaoLoginValida));
//        verify(authService).login(requisicaoLoginValida);
//    }
//
//    @Test
...
//
//        assertThrows(RuntimeException.class, () -> authController.register(requisicaoRegistroValida));
//        verify(authService).register(requisicaoRegistroValida);
//    }
//}
